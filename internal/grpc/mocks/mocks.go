...
//
//	mockgen -source payrollService.go -destination mocks/mocks.go -package mocks
//
...
func (mr *MockpayrollRepoMockRecorder) AddPayslip(ctx, payslipID, payrollID, grossPay, tax, netPay any) *gomock.Call {
...
func (mr *MockpayrollRepoMockRecorder) Create(ctx, payrollID, tenantID, payday any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockpayrollRepoMockRecorder) Find(ctx, payrollID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
