...
func NewPayrollServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) PayrollServiceClient {
	...
	return &payrollServiceClient{
		addPayroll: connect_go.NewClient[payrollv1.AddPayrollRequest, payrollv1.AddPayrollResponse](
			httpClient,
			baseURL+PayrollServiceAddPayrollProcedure,
			opts...,
		),
		addPayslip: connect_go.NewClient[payrollv1.AddPayslipRequest, payrollv1.AddPayslipResponse](
			httpClient,
			baseURL+PayrollServiceAddPayslipProcedure,
			opts...,
		),
		getPayroll: connect_go.NewClient[payrollv1.GetPayrollRequest, payrollv1.GetPayrollResponse](
			httpClient,
...
type payrollServiceClient struct {
	addPayroll *connect_go.Client[payrollv1.AddPayrollRequest, payrollv1.AddPayrollResponse]
	addPayslip *connect_go.Client[payrollv1.AddPayslipRequest, payrollv1.AddPayslipResponse]
	getPayroll *connect_go.Client[payrollv1.GetPayrollRequest, payrollv1.GetPayrollResponse]
}

// AddPayroll calls payroll.v1.PayrollService.AddPayroll.
func (c *payrollServiceClient) AddPayroll(ctx context.Context, req *connect_go.Request[payrollv1.AddPayrollRequest]) (*connect_go.Response[payrollv1.AddPayrollResponse], error) {
	return c.addPayroll.CallUnary(ctx, req)
}

// AddPayslip calls payroll.v1.PayrollService.AddPayslip.
func (c *payrollServiceClient) AddPayslip(ctx context.Context, req *connect_go.Request[payrollv1.AddPayslipRequest]) (*connect_go.Response[payrollv1.AddPayslipResponse], error) {
	return c.addPayslip.CallUnary(ctx, req)
}

// GetPayroll calls payroll.v1.PayrollService.GetPayroll.
func (c *payrollServiceClient) GetPayroll(ctx context.Context, req *connect_go.Request[payrollv1.GetPayrollRequest]) (*connect_go.Response[payrollv1.GetPayrollResponse], error) {
...
func (UnimplementedPayrollServiceHandler) AddPayroll(context.Context, *connect_go.Request[payrollv1.AddPayrollRequest]) (*connect_go.Response[payrollv1.AddPayrollResponse], error) {
...
func (UnimplementedPayrollServiceHandler) AddPayslip(context.Context, *connect_go.Request[payrollv1.AddPayslipRequest]) (*connect_go.Response[payrollv1.AddPayslipResponse], error) {
...
func (UnimplementedPayrollServiceHandler) GetPayroll(context.Context, *connect_go.Request[payrollv1.GetPayrollRequest]) (*connect_go.Response[payrollv1.GetPayrollResponse], error) {
